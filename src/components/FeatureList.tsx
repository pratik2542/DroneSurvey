        ...
        {filteredFeatures.length === 0 ? (
          ...
          <>
            ...
            {filteredFeatures.length > 100 && (
              <div className="text-center py-3.5 px-2 text-[10px] text-high-teal/60 font-medium bg-high-darker/30 border border-dashed border-high-border rounded-lg select-none">
                Showing first 100 of {filteredFeatures.length} features.
                <br />
                Use the search box above to narrow down specific items.
              </div>
            )}
          </>
        )}
